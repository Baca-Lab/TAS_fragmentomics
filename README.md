...
A step-by-step demo is available in the **/NRL_simulation/NRL_demo.ipynb** (Python version 3.9.23). Running all cells with our setup takes approximately 1 hour.
